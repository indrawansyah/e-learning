...
function getMoives(keyword) {
    ...
    xhr.open('get', 'http://www.omdbapi.com/?apikey=3dd96b6e&s=' + keyword);
    xhr.send();
    ...
    movies.forEach(function(movie) {
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="detail.php?id=${movie.imdbID}" class="btn btn-primary">Details</a>
            </div>
        </div>
    </div>`;
    });
